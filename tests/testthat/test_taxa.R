...
test_that("Test normalizeTaxa",{
  ...
  expect_equal(normalizeTaxa(list(c('species'='X','genus'='Y'),c('species'='A','genus'='C'))),matrix(c('X','A','Y','C'),nrow=2,dimnames=list(c(),c('species','genus'))))
  expect_equal(normalizeTaxa(list(c('species'='X','clade'='Z','genus'='Y'),c('species'='A','genus'='C'))),matrix(c('X','A','Z',NA,'Y','C'),nrow=2,dimnames=list(c(),c('species','genus.1','genus'))))
  expect_equal(normalizeTaxa(list(c('species'='X','clade'='Z','genus'='Y'),c('species'='A','clade.100'='Y','genus'='C'))),matrix(c('X','A','Z','Y','Y','C'),nrow=2,dimnames=list(c(),c('species','genus.1','genus'))))
  expect_equal(normalizeTaxa(list(c('species'='X','clade'='Z','genus'='Y'),c('species'='A','clade.1'='D','clade.100'='W','genus'='C'))),matrix(c('X','A',NA,'D','Z','W','Y','C'),nrow=2,dimnames=list(c(),c('species','genus.2','genus.1','genus'))))
  expect_equal(normalizeTaxa(list(c('clade'='Z','species'='X','genus'='Y'),c('species'='A','genus'='C'))),matrix(c('Z',NA,'X','A','Y','C'),nrow=2,dimnames=list(c(),c('species.1','species','genus'))))
  expect_equal(normalizeTaxa(list(c('species'='X','genus'='Y','clade'='Z'),c('species'='A','genus'='C'))),matrix(c('X','A','Y','C','Z',NA),nrow=2,dimnames=list(c(),c('species','genus','_ROOT_.1'))))
  expect_equal(normalizeTaxa(list(c('species'='X','genus'='Y','clade'='Z'),c('species'='A','genus'='C')),rootFill='XYZ'),matrix(c('X','A','Y','C','Z',NA),nrow=2,dimnames=list(c(),c('species','genus','XYZ.1'))))
  expect_equal(normalizeTaxa(list(c('species'='X','clade'='Z','genus'='Y','clade'='Z','clade'='Z','kingdom'='king'),c('species'='A','clade.1'='D','clade.100'='W','genus'='C','kingdom'='king'))),matrix(c('X','A',NA,'D','Z','W','Y','C','Z',NA,'Z',NA,'king','king'),nrow=2,dimnames=list(c(),c('species','genus.2','genus.1','genus','kingdom.2','kingdom.1','kingdom'))))
  expect_equal(normalizeTaxa(list(c('species'='X','clade'='Z','genus'='Y'),c('species'='A','genus'='C'),c('species'='12'))),matrix(c('X','A','12','Z',NA,NA,'Y','C',NA),nrow=3,dimnames=list(c(),c('species','genus.1','genus'))))
  expect_equal(normalizeTaxa(list('A'=c('species'='X','clade'='Z','genus'='Y'),'BB'=c('species'='A','genus'='C'),'CCC'=c('species'='12'))),matrix(c('X','A','12','Z',NA,NA,'Y','C',NA),nrow=3,dimnames=list(c('A','BB','CCC'),c('species','genus.1','genus'))))
  expect_error(normalizeTaxa(list('A'=c('species'='X','clade'='Z','genus'='Y'),'BB'=c('species'='A','genus'='C'),'CCC'=c('kingdom'='12'))),'[Aa]mbiguous')
  expect_equal(normalizeTaxa(list('A'=c('species'='X','clade'='Z','genus'='Y'),'BB'=c('species'='A','genus'='C'),'CCC'=c('kingdom'='12')),lineageOrder=c('genus','kingdom')),matrix(c('X','A',NA,'Z',NA,NA,'Y','C',NA,NA,NA,'12'),nrow=3,dimnames=list(c('A','BB','CCC'),c('species','genus.1','genus','kingdom'))))
})
